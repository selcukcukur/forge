  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className={cn("w-auto", className)} {...props}>
      <g fill="currentColor">
        ...
        <path d="M26.59,8.747c-1.023-1.134-2.533-1.566-3.927-1.269-.57,.121-.933,.682-.811,1.253,.122,.568,.682,.933,1.251,.809h0c.681-.144,1.42,.067,1.921,.62,.501,.555,.635,1.311,.42,1.975h0c-.179,.553,.124,1.148,.679,1.328,.555,.177,1.149-.125,1.328-.679,.437-1.357,.163-2.902-.862-4.037"></path>
        <path d="M13.735,20.765c-.185,.317-.595,.469-.916,.337-.316-.13-.415-.484-.235-.796,.185-.31,.579-.461,.893-.336,.32,.118,.435,.476,.258,.795m-1.688,2.167c-.512,.817-1.609,1.175-2.436,.798-.814-.371-1.055-1.321-.542-2.118,.506-.793,1.566-1.148,2.387-.803,.829,.354,1.095,1.297,.591,2.123m1.925-5.786c-2.521-.656-5.37,.6-6.465,2.822-1.115,2.265-.037,4.78,2.51,5.602,2.639,.851,5.748-.453,6.829-2.898,1.066-2.39-.265-4.851-2.874-5.526"></path>
      </g>
    </svg>
  )
}
